...
public final class Convert {
    ...
    /** @return encoder ticks per 100ms */
    public static double angularVelToEncoderVel(
            double degPerSec, double gearRatio, Encoder encoder) {
    ...
    public static double encoderVelToSpeed(
        ...
        return encoderVelToRevsPerSec(sensorUnitsPer100ms, gearRatio, encoder)
                * (diameter * Math.PI);
    }
