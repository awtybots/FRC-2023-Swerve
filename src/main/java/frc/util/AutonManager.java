...
public class AutonManager {
    ...
    public AutonManager(LimelightSubsystem s_Limelight) {
    ...
    public Command getSelected() {
        ...
        if (dashboardSelection == "_") {
            ...
            if (selectedCommand != null) {
                ...
                if (defaultCommand != null) {
                    System.out.printf("Running default autonomous `%s`\n", defaultCommand.getName());
                    return defaultCommand;
                } else {
                    System.out.println("No default autonomous was selected. Doing nothing for autonomous.");
                    return new InstantCommand();
                }
            }
        }
